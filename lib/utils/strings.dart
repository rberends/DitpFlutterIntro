class Strings {
  ...
  static const String introDesc = "A short look into the practicality of introducing yet another framework into our tech stack";

  static const String secondTitle = "Flutter is\nFrontend";
  static const String secondDesc = "Sitting on the same layer as React and Angular, Flutter is a frontend framework providing a way to make things graphically appealing and interactive.";

  static const String thirdTitle = "Flutter is\nMultiplatform";
  static const String thirdDesc = "With current six platforms supported, Flutter has become truly multiplatform.\n\nThere’s even an embedded use - Toyota uses it for an infotainment system for example";
  ...
  static const String tenthDesc = "Widgets can have a state - StatefulWidget or be stateless - the StatelessWidget class.";
  ...
  static const String thirteenth_3_text = "Flutter compiles to native binaries for each platform - but actually runs on a VM for development. Meaning easier debugging.!";
  static const String thirteenth_1_title = "Flutter compiles to native binaries for each platform - but actually runs on a VM for development. Meaning easier debugging.!";
  static const String thirteenth_2_title = "Flutter compiles to native binaries for each platform - but actually runs on a VM for development. Meaning easier debugging.!";
  static const String thirteenth_3_title = "Flutter compiles to native binaries for each platform - but actually runs on a VM for development. Meaning easier debugging.!";
  static const String thirteenth_1_desc = "Flutter compiles to native binaries for each platform - but actually runs on a VM for development. Meaning easier debugging.!";
