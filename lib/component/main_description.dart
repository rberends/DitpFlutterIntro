...
class MainDescription extends StatelessWidget {
  const MainDescription(this.description, {this.descriptionColor = dSecondaryColor});
    ...
    return
      Padding(
          ...
          style: Theme
                  .of(context)
                  .textTheme
                  .displayMedium?.apply(color: descriptionColor,  fontSizeFactor: max(SizeConfig.textScaleSize/9, 0.6))
    ));
  }
}